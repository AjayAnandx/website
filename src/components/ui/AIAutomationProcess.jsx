...
const steps = [
    {
        number: "1",
        title: "INSIGHT",
        description: "We analyze your business processes, data flows, and operational challenges to identify where AI automation can create the highest impact."
    },
    {
        number: "2",
        title: "STRATEGY",
        description: "We design a clear automation roadmap—defining workflows, AI models, integrations, and success metrics aligned with your business goals."
    },
    {
        number: "3",
        title: "BUILD",
        description: "We develop and integrate AI-powered automation systems that are secure, scalable, and seamlessly embedded into your existing tools."
    },
    {
        number: "4",
        title: "DEPLOY",
        description: "We test, refine, and deploy automation with precision—ensuring reliability, performance, and smooth adoption across teams."
    },
    {
        number: "5",
        title: "OPTIMIZE",
        description: "We continuously monitor, improve, and evolve your automation systems to adapt to changing data, processes, and business needs."
    }
];
        ...
        <section className="w-full bg-black text-white py-24 px-6 md:px-12 lg:px-24">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
                ...
                <div className="lg:w-1/2 lg:sticky lg:top-32 h-fit">
                    ...
                    >
                        <span className="text-xs font-mono uppercase tracking-[0.2em] text-white/50 mb-6 block">OUR AI AUTOMATION PROCESS</span>
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight leading-[1.1] mb-8">
                            A framework that powers intelligent automation
                        </h2>
                        <p className="text-white/60 text-lg leading-relaxed mb-10 max-w-xl">
                            Every successful automation begins with clarity and evolves through strategy, engineering, and continuous optimization. Our AI-driven framework ensures every system we build delivers efficiency, scalability, and measurable impact.
                        </p>
