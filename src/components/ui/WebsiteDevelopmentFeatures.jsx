        ...
        <svg viewBox="0 0 300 250" className="w-full h-full absolute inset-0 opacity-40 pointer-events-none">
            {rects.map((rect, i) => (
                <motion.rect
                    ...
                    fill="none"
                    stroke={rect.isRed ? '#8b5cf6' : 'rgba(255,255,255,0.2)'} // Violet for Web
...
const VioletSwirlGraphic = () => (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -right-10 -top-20 w-[150%] h-[150%] bg-gradient-to-bl from-violet-600/20 via-purple-500/10 to-transparent blur-3xl opacity-40 rounded-full" />
...
const IconGraphicFeatures = () => (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-60">
        <svg width="60" height="60" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-white/80">
            <motion.rect x="4" y="4" width="16" height="16" rx="2" initial={{ scale: 0.8, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 1 }} />
            <motion.rect x="8" y="2" width="8" height="2" fill="currentColor" initial={{ opacity: 0, y: -5 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} />
            <motion.rect x="8" y="20" width="8" height="2" fill="currentColor" initial={{ opacity: 0, y: 5 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} />
            <motion.circle cx="12" cy="12" r="2" fill="currentColor" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.8 }} />
        </svg>
    </div>
);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[280px]">
                    ...
                    <FeatureCard className="md:col-span-2 lg:col-span-2 lg:row-span-2 flex flex-col justify-between relative bg-gradient-to-b from-[#0f0f12] to-[#0a0a0a]">
                        ...
                        <div className="relative z-10 w-full">
                            <h3 className="text-violet-500 font-mono text-[10px] mb-3 tracking-widest uppercase">VISUAL EXCELLENCE</h3>
                            <h4 className="text-3xl font-medium mb-4 leading-snug">Pixel-perfect design,<br />Immersive experience</h4>
                            <p className="text-white/50 text-sm max-w-sm leading-relaxed">
                                We combine aesthetic brilliance with intuitive navigation to create websites that engage, retain, and convert visitors into loyal customers.
                            </p>
                        </div>
                        ...
                        <div className="relative z-10 mt-12 bg-black/40 backdrop-blur-md self-start rounded-lg p-4 pr-8 border border-white/5 shadow-lg">
                            <span className="text-[10px] text-white/40 block mb-1 uppercase tracking-wider">CONVERSION RATE</span>
                    ...
                    <FeatureCard className="md:col-span-2 lg:col-span-2 relative flex flex-col justify-end min-h-[280px]">
                        ...
                        <div className="relative z-10 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-2 -m-2 rounded-b-xl">
                            <h3 className="text-white/40 font-mono text-[10px] mb-2 uppercase tracking-widest">RESPONSIVE DESIGN</h3>
                            <h4 className="text-2xl font-medium text-white/90">Flawless on every device</h4>
                            <p className="text-white/50 text-xs mt-2 max-w-sm">
                                Quantum Scripts ensures your website looks and performs perfectly on mobiles, tablets, and desktops alike.
                            </p>
                        </div>
                    </FeatureCard>
                    ...
                    <FeatureCard className="md:col-span-1 lg:col-span-2 relative flex items-center justify-between min-h-[200px]">
                        <div className="relative z-10">
                            <h3 className="text-white/40 font-mono text-[10px] mb-2 uppercase tracking-widest">MODERN STACK</h3>
                            <h4 className="text-xl font-medium text-white/90">Next.js & React<br />Experts</h4>
                        </div>
                    ...
                    <FeatureCard className="md:col-span-1 lg:col-span-2 relative">
                        <DataGraphGraphic />
                        <div className="relative z-10">
                            <h3 className="text-green-500 font-mono text-[10px] mb-2 uppercase tracking-widest">SEO OPTIMIZED</h3>
                            <h4 className="text-xl font-medium mb-2 text-white/90">Built to rank<br />on page one</h4>
                            <p className="text-white/50 text-xs max-w-xs mt-3 leading-relaxed">
                                Our development adheres to core web vitals and technical SEO best practices from the very first line of code.
                            </p>
                        </div>
                    </FeatureCard>
                    ...
                    <FeatureCard className="md:col-span-2 lg:col-span-2 relative overflow-hidden flex flex-col justify-center">
                        ...
                        <div className="relative z-10 max-w-md bg-gradient-to-r from-black/60 to-transparent p-2 -m-2 rounded-l-xl">
                            <h3 className="text-yellow-500 font-mono text-[10px] mb-2 uppercase tracking-widest">SPEED</h3>
                            <h4 className="text-2xl font-medium mb-3 text-white/90">Blazing fast<br />load times</h4>
                            <p className="text-white/50 text-sm mb-6 leading-relaxed">
                                We optimize assets, implementation, and infrastructure to ensure your site loads instantly, keeping users engaged.
                            </p>
                            <div className="inline-flex items-center gap-3 bg-white/5 p-3 rounded-lg border border-white/5 backdrop-blur-sm">
                                <span className="text-[10px] text-white/40 uppercase tracking-widest">LOAD TIME</span>
                                <div className="text-xl font-bold text-green-400 flex items-center gap-1">0.5s <ArrowDownSmall /></div>
                            </div>
                        </div>
                    </FeatureCard>
