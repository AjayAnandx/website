...
const SoftwareDevelopmentHero = () => {
    ...
    const text = "From planning to performance, we build and evolve AI automation systems that streamline processes and scale with your business.";
    ...
    return (
        <section className="relative h-screen w-full overflow-hidden bg-gradient-to-b from-[#050505] via-[#111420] to-[#2a3555] flex flex-col justify-center px-8 md:px-20 lg:px-32">
            ...
            {/* Scroll Button - aligned left/start */}
            <motion.button
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 3.5, duration: 1 }} // Appears after text finishes
