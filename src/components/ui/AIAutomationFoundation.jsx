        ...
        <section className="w-full py-24 px-6 md:px-12 lg:px-24 bg-black relative z-10">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center text-center mb-20 gap-6">
                    ...
                    >
                        <span className="text-blue-500 font-mono text-xs uppercase tracking-[0.2em] mb-4 block">AI & AUTOMATION FOUNDATION</span>
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium text-white tracking-tight leading-[1.1] max-w-4xl">
                            The intelligence behind every automated system we build
                        </h2>
                    </motion.div>
                    <motion.div
                        className="max-w-2xl"
                    ...
                    >
                        <p className="text-[#a1a1aa] text-lg leading-relaxed">
                            We don’t just automate tasks—we design intelligent AI-driven workflows that reduce complexity, improve efficiency, and scale with your business. Discover how we help organizations work smarter.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <FoundationCard
                        ...
                        title="Clarity"
                        description="We identify where manual processes, inefficiencies, and data silos slow you down—then define clear automation strategies that drive measurable improvement."
                        icon={<IconClarity />}
                        delay={0.1}
                    ...
                    <FoundationCard
                        ...
                        title="Partnership"
                        description="We work as an extension of your team, aligning AI automation with your goals to ensure every solution fits seamlessly into your existing workflows."
                    ...
                    <FoundationCard
                        ...
                        title="Engineering"
                        description="We engineer robust AI automation systems that integrate across tools, scale intelligently, and deliver consistent performance."
                    ...
                    <FoundationCard
                        ...
                        title="Evolution"
                        description="Our automation systems evolve with your business—learning, adapting, and improving as processes, data, and demands change."
                        icon={<IconEvolution />}
                        delay={0.4}
                        className="lg:col-span-1 min-h-[280px]"
                    />
                    <FoundationCard
                        ...
                        title="Leadership"
                        description="AI automation helps you move faster, reduce operational costs, and build a sustainable competitive edge through smarter execution."
                        icon={<IconLeadership />}
                        delay={0.5}
                        className="lg:col-span-1 min-h-[280px]"
                    />
...
export default AIAutomationFoundation;
