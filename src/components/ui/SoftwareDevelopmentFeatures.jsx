        ...
        <svg viewBox="0 0 300 250" className="w-full h-full absolute inset-0 opacity-40 pointer-events-none">
            {rects.map((rect, i) => (
                <motion.rect
                    ...
                    fill="none"
                    stroke={rect.isRed ? '#ef4444' : 'rgba(255,255,255,0.2)'}
...
const RedSwirlGraphic = () => (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -right-10 -top-20 w-[150%] h-[150%] bg-gradient-to-bl from-red-600/20 via-orange-500/10 to-transparent blur-3xl opacity-40 rounded-full" />
...
const IconGraphicFeatures = () => (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-60">
        <svg width="60" height="60" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-white/80">
            <motion.circle cx="12" cy="12" r="8" initial={{ scale: 0.8, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 1 }} />
            <motion.circle cx="12" cy="12" r="3" fill="currentColor" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.5 }} />
            {[0, 90, 180, 270].map((deg, i) => (
                <motion.line key={i} x1="12" y1="2" x2="12" y2="5" transform={`rotate(${deg} 12 12)`} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 1 }} />
            ))}
        </svg>
    </div>
);
        ...
        <section className="min-h-screen w-full py-24 px-6 md:px-12 lg:px-24 text-white relative z-10">
            ...
            <div className="max-w-7xl mx-auto">
                <motion.h2
                    ...
                    viewport={{ once: true }}
                >
                    AI-powered automation solving complex business challenges.
                </motion.h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[280px]">
                    ...
                    <FeatureCard className="md:col-span-2 lg:col-span-2 lg:row-span-2 flex flex-col justify-between relative bg-gradient-to-b from-[#0f0f12] to-[#0a0a0a]">
                        ...
                        <div className="relative z-10 w-full">
                            <h3 className="text-red-500 font-mono text-[10px] mb-3 tracking-widest uppercase">PERFORMANCE FOCUS</h3>
                            <h4 className="text-3xl font-medium mb-4 leading-snug">Smarter workflows,<br />faster execution</h4>
                            <p className="text-white/50 text-sm max-w-sm leading-relaxed">
                                Automate repetitive processes, reduce manual effort, and improve operational efficiency using AI driven decision logic and intelligent workflows.
                            </p>
                        </div>
                        ...
                        <div className="relative z-10 mt-12 bg-black/40 backdrop-blur-md self-start rounded-lg p-4 pr-8 border border-white/5 shadow-lg">
                            <span className="text-[10px] text-white/40 block mb-1 uppercase tracking-wider">MANUAL EFFORT</span>
                    ...
                    <FeatureCard className="md:col-span-2 lg:col-span-2 relative flex flex-col justify-end min-h-[280px]">
                        ...
                        <div className="relative z-10 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-2 -m-2 rounded-b-xl">
                            <h3 className="text-white/40 font-mono text-[10px] mb-2 uppercase tracking-widest">PLATFORM CAPABILITY</h3>
                            <h4 className="text-2xl font-medium text-white/90">Scalable AI systems built for growth</h4>
                            <p className="text-white/50 text-xs mt-2 max-w-sm">
                                Quantum Scripts designs AI automation systems that scale seamlessly across teams and tools.
                            </p>
                        </div>
                    </FeatureCard>
                    ...
                    <FeatureCard className="md:col-span-1 lg:col-span-2 relative flex items-center justify-between min-h-[200px]">
                        <div className="relative z-10">
                            <h3 className="text-white/40 font-mono text-[10px] mb-2 uppercase tracking-widest">FEATURE CALLOUT</h3>
                            <h4 className="text-xl font-medium text-white/90">AI-powered<br />process optimization</h4>
                        </div>
                    ...
                    <FeatureCard className="md:col-span-1 lg:col-span-2 relative">
                        <DataGraphGraphic />
                        <div className="relative z-10">
                            <h3 className="text-blue-500 font-mono text-[10px] mb-2 uppercase tracking-widest">ANALYTICS & INTELLIGENCE</h3>
                            <h4 className="text-xl font-medium mb-2 text-white/90">Advanced analytics &<br />intelligent insights</h4>
                            <p className="text-white/50 text-xs max-w-xs mt-3 leading-relaxed">
                                Track automation performance, monitor system health, and uncover growth opportunities.
                            </p>
                        </div>
                    </FeatureCard>
                    ...
                    <FeatureCard className="md:col-span-2 lg:col-span-2 relative overflow-hidden flex flex-col justify-center">
                        ...
                        <div className="relative z-10 max-w-md bg-gradient-to-r from-black/60 to-transparent p-2 -m-2 rounded-l-xl">
                            <h3 className="text-yellow-500 font-mono text-[10px] mb-2 uppercase tracking-widest">BUSINESS OUTCOME</h3>
                            <h4 className="text-2xl font-medium mb-3 text-white/90">More output with the<br />same resources</h4>
                            <p className="text-white/50 text-sm mb-6 leading-relaxed">
                                AI automation enables teams to handle higher workloads without increasing operational costs driving scalability.
                            </p>
